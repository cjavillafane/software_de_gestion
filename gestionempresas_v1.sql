...
CREATE TABLE IF NOT EXISTS `compras` (
  ...
  PRIMARY KEY (`idcompra`, `empresas_idempresa`, `personas_idpersona`,`periodos_idperiodo`),
  UNIQUE INDEX `idcompras` (`idcompra`),
  UNIQUE INDEX `compras` (`idcompra`, `empresas_idempresa`, `personas_idpersona`,`periodos_idperiodo` ASC),
  ...
  INDEX `fk_compras_periodos1_idx` (`periodos_idperiodo` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_compras_personas1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_compras_periodos1`
...
CREATE TABLE IF NOT EXISTS `ventas` (
  ...
  `personas_idpersona` INT NOT NULL,
  `periodos_idperiodo` INT NOT NULL,
  PRIMARY KEY (`idventa`, `empresas_idempresa`, `personas_idpersona`,`periodos_idperiodo`),
  UNIQUE INDEX `pkventas` (`idventa`, `empresas_idempresa`, `personas_idpersona`,`periodos_idperiodo`),
  ...
  INDEX `fk_ventas_periodos_idx` (`periodos_idperiodo` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_ventas_personas1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_ventas_periodos1`
    FOREIGN KEY (`periodos_idperiodo`)
    REFERENCES `periodos` (`idperiodo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
